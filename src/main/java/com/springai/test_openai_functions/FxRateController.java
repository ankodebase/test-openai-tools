...
public class FxRateController {
    ...
    public String getFxRate(@RequestParam String from, @RequestParam String to) {
        SystemMessage systemMessage = new SystemMessage("You are a financial expert. Provide accurate and up-to-date foreign exchange rates. Do not make up rates if you don't know them. Also do not search Web");
        UserMessage userMessage = new UserMessage(String.format("What is the current FX rate from %s to %s?", from, to));
        Resource r = new ClassPathResource("mm");
        UserMessage m = new UserMessage("ccc",new Media(MimeTypeUtils.IMAGE_PNG,r));
